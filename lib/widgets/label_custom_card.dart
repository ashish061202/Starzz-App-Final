...
//Me Try2
class LabelCustomCard extends StatefulWidget {
  const LabelCustomCard({
    super.key,
  ...
  @override
  State<LabelCustomCard> createState() => _LabelCustomCardState();
}

class _LabelCustomCardState extends State<LabelCustomCard> {
                              ...
                              FutureBuilder<Map<String, dynamic>?>(
                                ...
                                builder: (context, snapshot) {
                                  if (snapshot.connectionState ==
                                    ...
                                    final timestampColor = newMessageCount > 0
                                        ? Colors.green
                                        : Colors.grey.shade700;
                                    final isDarkModeTime =
                                        newMessageCount > 0 && Get.isDarkMode
                                            ? Colors.green
                                            : Colors.grey;
                                  ...
                                  builder: (context, snapshot) {
                                    if (snapshot.connectionState ==
                                      ...
                                      final isPhoneNumberIdMatch =
                                          lastMessage['isPhoneNumberIdMatch'] ??
                                              false;
                                        ...
                                        if (lastMessage['type'] == 'document') {
                                          ...
                                          if (interactiveData != null) {
                                            ...
                                            if (nfmReplyData != null) {
                                              final body = nfmReplyData['body']
                                                  as String?;
                                              final name = nfmReplyData['name']
                                                  as String?;
                                              final responseJson =
